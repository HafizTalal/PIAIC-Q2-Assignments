...
def function5():
    ...
    z = np.zeros(20, np.int8).reshape(4,-1)#wrtie your code here
...
def function12():
    ...
    arr = np.array([1,2,3])
    ans = np.hstack([arr.repeat(3) , np.tile(arr,3)])#write your code here 
...
def function16():
    ...
    x = np.array([[1], [2], [3]])
    y = np.array([[2], [3], [4]])
    ans = np.stack((x,y),-1)#write your code here 
...
def function18():
    ...
    x = x =len(np.intersect1d(piaic,students))# Write you code Here
    return x
